...
# zsh configurations folder
# Break up this file and keep different configuration files there
# This is not automatically loaded (currently)
ZSHRC_DIR="$DOTFILES_DIR/zsh/zshrc"
