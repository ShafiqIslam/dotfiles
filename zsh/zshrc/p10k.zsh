# Generated by Powerlevel10k configuration wizard on 2020-06-28 at 14:00 +06.
...
# sharp heads, blurred tails, 2 lines, dotted, left frame, light-ornaments, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{blue}╰─ᐉ%f'
